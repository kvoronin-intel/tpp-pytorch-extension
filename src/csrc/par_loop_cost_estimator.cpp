...
void set_platform_specs(
  ...
  if (platform == SPR_DDR) {
    double total_threads = 56.0;
    double load_factor_to_spill_cache = 0.75;
    platform_specs->l1_size_in_bytes =
        48.0 * 1024.0 * load_factor_to_spill_cache;
    platform_specs->l2_size_in_bytes =
        2.0 * 1024.0 * 1024.0 * load_factor_to_spill_cache;
    platform_specs->llc_size_in_bytes = 105.0 * 1024.0 * 1024.0 /
        (total_threads / (1.0 * n_threads)) * load_factor_to_spill_cache;
    platform_specs->l1_bytes_per_cycle = 128.0;
    platform_specs->l2_bytes_per_cycle = 48.0;
    platform_specs->llc_bytes_per_cycle = 8.0;
    platform_specs->mem_bytes_per_cycle = 2.2;
    platform_specs->bf16_flops_per_cycle_out_of_L2 = 732.0;
    platform_specs->fp32_flops_per_cycle_out_of_L2 = 73.0;
    platform_specs->freq_in_ghz = 2.0;
