...
def train(args, train_dataset, model, tokenizer):
    ...
    if args.use_pcl:
        optimizer = ppx.optim.AdamW(optimizer_grouped_parameters, lr=args.learning_rate, eps=args.adam_epsilon)
    else:
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
          ...
          with torch.autograd.profiler.profile(enabled=args.profile, use_cuda=(args.n_gpu > 0), record_shapes=record_shapes) as prof:
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                with torch.autograd.profiler.record_function("clip_grad_norm"):
                    if args.fp16:
                        ...
                        ppx.optim.clip_grad_norm_(model.parameters(), args.max_grad_norm)
                    else:
            ...
            if prof and args.use_pcl: ppx.print_debug_timers(-1)
